...
import { dispatchEvent } from '@qwik-microfrontends/mfe';
import { Counter, type CounterStore } from '@qwik-microfrontends/ui';
import { Detail } from '../components/Detail';

export const APP_VALUE_CHANGED_EVENT = '-APP_VALUE_CHANGED_EVENT';
